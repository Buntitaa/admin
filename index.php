...
$host = "localhost"; // ใส่ข้อมูลของคุณ
$username = "root";
$password = "12345678";
$database = "data_license";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">แสดงผลรวมทั้งหมด</h1>
                    </div>
...
try {
    ...
    // ดึงข้อมูลออกมาแสดง
    if ($rowCount > 0) { $data = $stmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    // แสดงข้อผิดพลาดในกรณีที่ไม่สามารถดึงข้อมูลได้
                        ...
                        <!-- <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4"> -->
                                ...
                                <!-- <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">แสดงรายได้ทั้งหมด (เดือน)</h6>
